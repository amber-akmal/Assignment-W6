...
let T=51;
if (T<8){console.log("It is cold wear warm clothes");}
if (T>8 && T<18){console.log("Temperature is normal wear Normal clothes");}
if (T>18) {console.log("Temperature is Hot wear light clothes");}
